...
public class BatchReader {
  ...
  public JpaPagingItemReader<CreditCardMovementModel> readerMovements(EntityManagerFactory entityManagerFactory) {
    ...
    reader.setQueryString(
        "SELECT movements FROM CreditCardMovementModel AS movements LEFT JOIN movements.installments AS installments WHERE movements.paid IS FALSE AND installments IS NULL");
    reader.setPageSize(10000); // Define o tamanho da página, leia 10 registros por vez
